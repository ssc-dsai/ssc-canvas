...
export declare const TitleGenerationAnnotation: import("@langchain/langgraph")._INTERNAL_ANNOTATION_ROOT<{
    /**
...
export type TitleGenerationReturnType = Partial<typeof TitleGenerationAnnotation.State>;
