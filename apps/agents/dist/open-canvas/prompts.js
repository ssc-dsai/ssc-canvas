...
exports.PORT_LANGUAGE_CODE_ARTIFACT_PROMPT = exports.FIX_BUGS_CODE_ARTIFACT_PROMPT = exports.ADD_LOGS_TO_CODE_ARTIFACT_PROMPT = exports.ADD_COMMENTS_TO_CODE_ARTIFACT_PROMPT = exports.FOLLOWUP_ARTIFACT_PROMPT = exports.ROUTE_QUERY_PROMPT = exports.NO_ARTIFACT_PROMPT = exports.CURRENT_ARTIFACT_PROMPT = exports.ROUTE_QUERY_OPTIONS_NO_ARTIFACTS = exports.ROUTE_QUERY_OPTIONS_HAS_ARTIFACTS = exports.ADD_EMOJIS_TO_ARTIFACT_PROMPT = exports.CHANGE_ARTIFACT_LENGTH_PROMPT = exports.CHANGE_ARTIFACT_TO_PIRATE_PROMPT = exports.CHANGE_ARTIFACT_READING_LEVEL_PROMPT = exports.CHANGE_ARTIFACT_LANGUAGE_PROMPT = exports.UPDATE_ENTIRE_ARTIFACT_PROMPT = exports.OPTIONALLY_UPDATE_META_PROMPT = exports.GET_TITLE_TYPE_REWRITE_ARTIFACT = exports.UPDATE_HIGHLIGHTED_ARTIFACT_PROMPT = exports.NEW_ARTIFACT_PROMPT = void 0;
...
`;
exports.NEW_ARTIFACT_PROMPT = `You are an AI assistant tasked with generating a new artifact based on the users request.
...
exports.UPDATE_HIGHLIGHTED_ARTIFACT_PROMPT = `You are an AI assistant, and the user has requested you make an update to a specific part of an artifact you generated in the past.
...
exports.GET_TITLE_TYPE_REWRITE_ARTIFACT = `You are an AI assistant who has been tasked with analyzing the users request to rewrite an artifact.
...
exports.OPTIONALLY_UPDATE_META_PROMPT = `It has been pre-determined based on the users message and other context that the type of the artifact should be:
{artifactType}

{artifactTitle}

You should use this as context when generating your response.`;
exports.UPDATE_ENTIRE_ARTIFACT_PROMPT = `You are an AI assistant, and the user has requested you make an update to an artifact you generated in the past.
...
exports.CHANGE_ARTIFACT_LANGUAGE_PROMPT = `You are tasked with changing the language of the following artifact to {newLanguage}.
...
exports.CHANGE_ARTIFACT_READING_LEVEL_PROMPT = `You are tasked with re-writing the following artifact to be at a {newReadingLevel} reading level.
...
exports.CHANGE_ARTIFACT_TO_PIRATE_PROMPT = `You are tasked with re-writing the following artifact to sound like a pirate.
...
exports.CHANGE_ARTIFACT_LENGTH_PROMPT = `You are tasked with re-writing the following artifact to be {newLength}.
...
exports.ADD_EMOJIS_TO_ARTIFACT_PROMPT = `You are tasked with revising the following artifact by adding emojis to it.
...
exports.ROUTE_QUERY_OPTIONS_HAS_ARTIFACTS = `
...
exports.ROUTE_QUERY_OPTIONS_NO_ARTIFACTS = `
- 'generateArtifact': The user has inputted a request which requires generating an artifact.
- 'replyToGeneralInput': The user submitted a general input which does not require making an update, edit or generating a new artifact. This should ONLY be used if you are ABSOLUTELY sure the user does NOT want to make an edit, update or generate a new artifact.`;
exports.CURRENT_ARTIFACT_PROMPT = `This artifact is the one the user is currently viewing.
<artifact>
{artifact}
</artifact>`;
exports.NO_ARTIFACT_PROMPT = `The user has not generated an artifact yet.`;
exports.ROUTE_QUERY_PROMPT = `You are an assistant tasked with routing the users query based on their most recent message.
...
exports.FOLLOWUP_ARTIFACT_PROMPT = `You are an AI assistant tasked with generating a followup to the artifact the user just generated.
...
exports.ADD_COMMENTS_TO_CODE_ARTIFACT_PROMPT = `You are an expert software engineer, tasked with updating the following code by adding comments to it.
...
exports.ADD_LOGS_TO_CODE_ARTIFACT_PROMPT = `You are an expert software engineer, tasked with updating the following code by adding log statements to it.
...
exports.FIX_BUGS_CODE_ARTIFACT_PROMPT = `You are an expert software engineer, tasked with fixing any bugs in the following code.
...
exports.PORT_LANGUAGE_CODE_ARTIFACT_PROMPT = `You are an expert software engineer, tasked with re-writing the following code in {newLanguage}.
